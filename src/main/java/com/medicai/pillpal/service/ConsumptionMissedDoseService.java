...
@Service
@Transactional
public class ConsumptionMissedDoseService {

    private final Logger log = LoggerFactory.getLogger(ConsumptionMissedDoseService.class);
    ...
    public ConsumptionMissedDoseService(ConsumptionMissedDoseRepository consumptionMissedDoseRepository, ConsumptionMissedDoseMapper consumptionMissedDoseMapper) {
