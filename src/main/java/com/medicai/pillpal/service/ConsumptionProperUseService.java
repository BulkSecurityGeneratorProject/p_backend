...
public interface ConsumptionProperUseService {
     ...
     */
    Optional<ConsumptionProperUseDTO> findAllergyByGenericName(String genericName);
     ...
     * @return the list of entities.
     */
    Page<ConsumptionProperUseDTO> findAllergyByGenericNameList(Pageable pageable, List<String> genericNameList);
