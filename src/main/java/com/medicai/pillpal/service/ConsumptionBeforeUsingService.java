...
@Service
@Transactional
public class ConsumptionBeforeUsingService {

    private final Logger log = LoggerFactory.getLogger(ConsumptionBeforeUsingService.class);
    ...
    public ConsumptionBeforeUsingService(ConsumptionBeforeUsingRepository consumptionBeforeUsingRepository, ConsumptionBeforeUsingMapper consumptionBeforeUsingMapper) {
