...
@Service
@Transactional
public class ConsumptionDosingService {

    private final Logger log = LoggerFactory.getLogger(ConsumptionDosingService.class);
    ...
    public ConsumptionDosingService(ConsumptionDosingRepository consumptionDosingRepository, ConsumptionDosingMapper consumptionDosingMapper) {
