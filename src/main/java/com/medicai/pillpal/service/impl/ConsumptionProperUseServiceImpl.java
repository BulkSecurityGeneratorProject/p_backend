...
public class ConsumptionProperUseServiceImpl implements ConsumptionProperUseService {
     ...
     */
    @Override
    public Optional<ConsumptionProperUseDTO> findAllergyByGenericName(String genericName) {
        log.debug("Request to get ApplicationInfo : {}", genericName);
        return consumptionProperUseRepository.findByGenericName(genericName)
            .map(consumptionProperUseMapper::toDto);
    }
     ...
     */
    @Override
    public Page<ConsumptionProperUseDTO> findAllergyByGenericNameList(Pageable pageable, List<String> genericNameList) {
        log.debug("Request to get ApplicationInfo : {}", pageable);
        return consumptionProperUseRepository.findByGenericNameList(pageable, genericNameList)
            .map(consumptionProperUseMapper::toDto);
    }
}
