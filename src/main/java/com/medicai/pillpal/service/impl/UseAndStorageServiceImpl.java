...
@Service
@Transactional
public class UseAndStorageServiceImpl implements UseAndStorageService {

    private final Logger log = LoggerFactory.getLogger(UseAndStorageServiceImpl.class);

    private final UseAndStorageRepository useAndStorageRepository;

    private final UseAndStorageMapper useAndStorageMapper;

    public UseAndStorageServiceImpl(UseAndStorageRepository useAndStorageRepository, UseAndStorageMapper useAndStorageMapper) {
